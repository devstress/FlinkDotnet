...
#pragma warning restore S4036
    ...
    private async Task CollectVertexMetricsAsync(string flinkJobId, JobMetricsBuilder metrics)
    {
        ...
        // Note: JobGateway no longer queries Prometheus for Flink metrics
        // Tests should query Prometheus directly for comprehensive metrics
        // JobGateway only provides job-level metrics from Flink REST API
