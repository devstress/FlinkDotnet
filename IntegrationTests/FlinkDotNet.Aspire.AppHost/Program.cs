...
// Observability Stack for Integration Testing - Simplified for CI/CD compatibility
// Note: Full observability stack (Prometheus, Grafana, Tempo) can be added when needed
// but keeping minimal for reliable CI/CD execution
...
Console.WriteLine("");
Console.WriteLine("💡 To add full observability stack (Prometheus, Grafana, Tempo),");
Console.WriteLine("   uncomment the observability section in Program.cs");
