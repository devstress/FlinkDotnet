...
Attempt 1 of 3: Pushing flinkdotnet/jobgateway:1.0.0...
✅ Successfully pushed flinkdotnet/jobgateway:1.0.0
```
...
✅ Docker image loaded successfully
Attempt 1 of 3: Pushing flinkdotnet/jobgateway:1.0.0...
⚠️  Push failed for flinkdotnet/jobgateway:1.0.0 (attempt 1/3)
Waiting 10 seconds before retry...
Re-authenticating with Docker Hub...
Attempt 2 of 3: Pushing flinkdotnet/jobgateway:1.0.0...
✅ Successfully pushed flinkdotnet/jobgateway:1.0.0
```
...
Re-authenticating with Docker Hub...
Attempt 2 of 3: Pushing flinkdotnet/jobgateway:1.0.0...
⚠️  Push failed for flinkdotnet/jobgateway:1.0.0 (attempt 2/3)
Waiting 10 seconds before retry...
Re-authenticating with Docker Hub...
Attempt 3 of 3: Pushing flinkdotnet/jobgateway:1.0.0...
⚠️  Push failed for flinkdotnet/jobgateway:1.0.0 (attempt 3/3)
❌ Failed to push flinkdotnet/jobgateway:1.0.0 after 3 attempts
```
